  ...
  return (
    <>
      <div className="min-w-[80%] max-w-[80%] min-h-screen justify-center items-center flex-wrap p-2 rounded-xl flex flex-col gap-10">
        <div className="topbar w-full flex-wrap-reverse sm:flex-wrap overflow-hidden flex justify-center sm:justify-end bg-white/10 rounded-xl gap-3 p-4 shadow-white/10 drop-shadow-2xl shadow-2xl">
          ...
          <div className="inline p-2 uppercase font-med bg-white/10 rounded-md border-1 border-gray-500 ">
            total Typos : {typos}
          </div>
        ...
        <div className="w-full flex-wrap overflow-hidden flex justify-end bg-white/10 rounded-xl gap-2 p-6 shadow-white/20 drop-shadow-2xl shadow-2xl text-white border-1 border-gray-500 ">
          {/* 
            ...
            <span
              ...
              style={{
                transform: `translateY(-${
                  Math.floor(currentIdx / charsPerLine) * lineHeight
                }px)`,
              }}
            >
